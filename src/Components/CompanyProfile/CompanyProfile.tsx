...
const CompanyProfile = (props: Props) => {
    const ticker = useOutletContext<string>(); //  เป็น hook ใน React Router ที่ใช้เพื่อให้ลูกหลาน (Child Component) ที่ถูก Render โดย <Outlet> สามารถเข้าถึงค่าที่ถูกส่งผ่านจากพาเรน (Parent Route)
